                    ...
                    <div class="col-lg-6">
                        <div class="text-center p-5" style="background: rgba(51, 33, 29, .8);">
                            ...
                            <form class="mb-5" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="password" class="form-control bg-transparent border-primary p-4" placeholder="password" name="pass" required="required" />
                                </div>
                                <?php
                                if (isset($error)) {
                                ...
                                ?>
                                <div>
                                    <button class="btn btn-primary btn-block font-weight-bold py-3 mb-4" type="submit">log in</button>
                                </div>
                                <a href="reset_password.php" class="m-auto me-3" style="font-size:18px;">Forgot password?</a>
                                <!-- <a href="register.php" class="m-auto" style="font-size:18px;">Register Now</a> -->
                            </form>
                        </div>
                    </div>
