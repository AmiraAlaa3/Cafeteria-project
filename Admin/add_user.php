...
<body>
    ...
    <!-- main  -->
    <main class="container marginTop" id="styleofmain">
        ...
        <form class="container shadow-lg ccc" id="styleofform" action="process_add.php" method="post" enctype="multipart/form-data">
            <div class="mb-3">
